...
// 修改、删除、读取某个down都用这个
type Change_One_Up struct {
	DotName     string
	ContextName string
	UpValue     string
}

func (c *Change_One_Up) MarshalBinary() (data []byte, err error) {
...
func (c *Change_One_Up) UnmarshalBinary(data []byte) (err error) {
	defer func() {
