...
const (
	...
	DOT_ID_MAX_LENGTH_V2 = 200 // dot版本号为1与2的id最大长度

	DOT_CONTENT_MAX_IN_DATA_V2 = 500 // dot版本号为2的content内连配置数据的最大长度
)
...
const (
	...
	DOT_CONTEXT_UP_DOWN_INDEX_INDATA                                             // 数据在里面（不足DOT_CONTENT_MAX_IN_DATA_V2的bit长度）
	DOT_CONTEXT_UP_DOWN_INDEX_OUTDATA                                            // 数据在外面（超过DOT_CONTENT_MAX_IN_DATA_V2的bit长度）
